...
<div class="page text-center">
            ...
            <nav data-md-device-layout="rd-navbar-fixed" data-lg-device-layout="rd-navbar-static" data-md-stick-up-offset="120px" data-lg-stick-up-offset="120px" class="rd-navbar rd-navbar-minimal rd-navbar-light " data-lg-auto-height="true" data-md-layout="rd-navbar-static" data-lg-layout="rd-navbar-static" data-lg-stick-up="true">
                <div class="rd-navbar-inner">
                    <div class="rd-navbar-top-panel">
                        <!--Navbar Brand-->
                        <div class="rd-navbar-brand veil reveal-md-inline-block"><a href="{{URL::action("Auth\LoginController@login")}}"><img width='197' height='52' class='img-responsive' src='{{asset('images/logo-dark.png')}}' alt=''/></a></div>
                        <div>
                            <!-- Contact Info-->
                    ...
                    <div class="rd-navbar-panel">
                        ...
                        <!--Navbar Brand-->
                        <div class="rd-navbar-brand veil-md"><a href="{{URL::action("Auth\LoginController@login")}}"><img width='197' height='52' class='img-responsive' src='{{asset('images/logo-dark.png')}}' alt=''/></a></div>
                    ...
                    <div class="rd-navbar-menu-wrap">
                        <div class="rd-navbar-nav-wrap">
                            <div class="rd-navbar-mobile-scroll">
                                <!--Navbar Brand Mobile-->
                                <div class="rd-navbar-mobile-brand"><a href="{{URL::action("Auth\LoginController@login")}}"><img width='197' height='52' class='img-responsive' src='{{asset('images/logo-dark.png')}}' alt=''/></a></div>
    ...
    <footer class="section-relative section-top-66 section-bottom-20 page-footer bg-bondi-blue context-dark">
                ...
                <div class="cell-sm-8 cell-md-12">
                    <div class="range range-xs-center">
                        <div class="cell-xs-10 cell-md-4 text-left cell-md-push-3 inset-md-left-50">
                            ...
                            <p class="text-white-02">Enter your email address to receive up-to-date news and new patient information.</p>
                            ...
                            <div class="text-center text-lg-left">
                                <address class="contact-info reveal-sm-inline-block text-left">
                                    <div class="p unit unit-spacing-xxs unit-horizontal">
                                        ...
                                        <div class="unit-body"><a href="callto:#" class="text-white">1-800-1234-567</a><span class="text-white">, </span><a href="callto:#" class="text-white">1-800-3214-321</a></div>
                                    </div>
                                    <div class="p unit unit-horizontal unit-spacing-xxs">
                                        ...
                                        <div class="unit-body"><a href="#" class="text-white">2130 Fulton Street San Diego, CA 94117-1080 USA</a></div>
                                    </div>
                                    <div class="p unit unit-spacing-xxs unit-horizontal offset-top-16">
                                        ...
                                        <div class="unit-body"><a href="mailto:#" class="text-primary text-primary-hovered">info@demolink.org</a></div>
                                    </div>
                                </address>
                            </div>
                        </div>
                        <div class="cell-xs-10 offset-top-66 cell-md-4 cell-md-push-1 offset-md-top-0">
                            <!-- Footer brand-->
                            <div class="footer-brand"><a href="index.html"><img width='206' height='63' class='img-responsive' src='{{asset('images/logo.png')}}' alt=''/></a></div>
                            <div class="offset-top-50 offset-md-top-90">
                                <ul class="list-inline">
                                    ...
                                    <li><a href="#" class="icon fa fa-google-plus icon-xxs icon-circle icon-white-filled"></a></li>
        ...
        <div class="shell offset-top-14">
            <p class="text-white-05 text-md-left">&copy; <span id="copyright-year"></span> All Rights Reserved Terms of Use <a href="privacy.html" class="text-white-05">Privacy Policy</a>
            </p>
        </div>
    </footer>
</div>
